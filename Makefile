...
LDFLAGS:= /usr/lib/gcc/arm-none-eabi/13.1.0/thumb/v6-m/nofp/libgcc.a
OBJS:=main.o usart.o tft.o delay.o vector_table.o Libreria/system_stm32f30x.o gfx.o tft-dma.o touch.o oscilloscope.o
